...
* The original package name 'com.ajudaqui.heimdall-api' is invalid and this project uses 'com.ajudaqui.heimdall_api' instead.
...
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/data/nosql.html#data.nosql.redis)
